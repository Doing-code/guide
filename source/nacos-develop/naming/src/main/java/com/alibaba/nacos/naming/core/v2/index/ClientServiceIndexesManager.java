...
public class ClientServiceIndexesManager extends SmartSubscriber {
    ...
    /**
     * 处理ClientOperationEvent.ClientRegisterServiceEvent
     *
     * 接收到客户端注册后，向服务对应的客户端集合 publisherIndexes 添加该注册客户端，
     *  既然该服务有新的客户端注册，说明服务发生了变更，所以还会发布服务变更事件
     * @param service
     * @param clientId
     */
    private void addPublisherIndexes(Service service, String clientId) {
        ...
        // NamingSubscriberServiceV2Impl 监听
        // 负责向订阅该服务的订阅者发起推送 serviceInfo 请求
