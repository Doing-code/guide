...
![image-20210922111651314](../image/assets/image-20210922111651314.png)
...
![image-20210907201333049](../image/assets/image-20210907201333049.png)
...
![image-20210907215903335](../image/assets/image-20210907215903335.png)
...
![image-20210908141019175](../image/assets/image-20210908141019175.png)

### 2.2.5.客户端注册的流程图

如图：

![image-20210923185331470](../image/assets/image-20210923185331470.png)

## 2.3.服务端

在nacos-console的模块中，会引入nacos-naming这个模块：

![image-20210922112801808](../image/assets/image-20210922112801808.png)

模块结构如下：

![image-20210922112954630](../image/assets/image-20210922112954630.png)

其中的com.alibaba.nacos.naming.controllers包下就有服务注册、发现等相关的各种接口，其中的服务注册是在`InstanceController`类中：

![image-20210922113158618](../image/assets/image-20210922113158618.png)
...
![image-20210922141703128](../image/assets/image-20210922141703128.png)
...
![image-20210922161705573](../image/assets/image-20210922161705573.png)
...
![image-20210922180246555](../image/assets/image-20210922180246555.png)
...
![image-20210922195603450](../image/assets/image-20210922195603450.png)
...
![image-20210923214042926](../image/assets/image-20210923214042926.png)
...
![image-20210922213313677](../image/assets/image-20210922213313677.png)

### 3.1.2.BeatReactor

而`BeatReactor`这个类则维护了一个线程池：

![image-20210922213455549](../image/assets/image-20210922213455549.png)
...
![image-20210922213829632](../image/assets/image-20210922213829632.png)
...
![image-20210922221022107](../image/assets/image-20210922221022107.png)
...
![image-20210922221344417](../image/assets/image-20210922221344417.png)
...
![image-20210923100740065](../image/assets/image-20210923100740065.png)
...
![image-20210923102824451](../image/assets/image-20210923102824451.png)
...
![image-20210923153419392](../image/assets/image-20210923153419392.png)
...
- 如果本地缓存没有，立即去nacos读取，`updateServiceNow(serviceName, clusters)`
  ...
  ![image-20210923161528710](../image/assets/image-20210923161528710.png)

- 如果本地缓存有，则开启定时更新功能，并返回缓存结果：
  
  - `scheduleUpdateIfAbsent(serviceName, clusters)`
  
  ![image-20210923161630575](../image/assets/image-20210923161630575.png)
  
  在UpdateTask中，最终还是调用updateService方法：
  
  ![image-20210923161752521](../image/assets/image-20210923161752521.png)
...
![image-20210923164145915](../image/assets/image-20210923164145915.png)
...
![image-20210923182429636](../image/assets/image-20210923182429636.png)

这个是事件监听器接口，监听的是ServiceChangeEvent（服务变更事件）。

当服务列表变化时，就会通知我们：

![image-20210923183017424](../image/assets/image-20210923183017424.png)
